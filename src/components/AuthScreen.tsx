...
import { Car, Lock, Mail, Eye, EyeOff, Sparkles, AlertCircle } from "lucide-react";
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      if (err.code !== "auth/popup-closed-by-user") {
        setError("Erro ao realizar login com o Google. Tente novamente.");
      }
    } finally {
      setLoading(false);
    }
    ...
    <div id="auth-screen-container" className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col justify-center items-center p-4 selection:bg-cyan-500 selection:text-neutral-900">
      ...
      >
        ...
        <button
          ...
          disabled={loading}
          className="w-full mb-3 bg-neutral-950 hover:bg-neutral-850 border border-neutral-800 hover:border-neutral-700 text-neutral-200 font-medium py-2.5 px-4 rounded-xl transition-all flex items-center justify-center gap-2.5 cursor-pointer text-sm"
        >
        ...
        <button
          ...
          className="w-full bg-neutral-950 hover:bg-neutral-900 border border-neutral-800 hover:border-emerald-500/30 text-emerald-400 hover:text-emerald-300 font-medium py-2.5 px-4 rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer text-sm"
        >
